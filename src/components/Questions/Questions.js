...
export default function Questions() {
    ...
    const fetchAllQuestions = async () => {
        await fetch(`${mates_backend}/question/fetchquestions`, {
            method: "POST",
            headers: {
    ...
    const sortByVotes = async () => {
        await fetch(`${mates_backend}/question/fetchQueByHigherVotes`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const answeredQuestions = async()=>{
        await fetch(`${mates_backend}/question/answeredQue`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const unansweredQuestions = async() => {
        await fetch(`${mates_backend}/question/unansweredQue`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
