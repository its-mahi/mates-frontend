...
export default function MyQuestions() {
    ...
    const fetchAllFilteredQuestions = async () => {
        const response = await fetch(`${mates_backend}/question/fetchUserFilteredQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch(`${mates_backend}/question/usedtags/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    useEffect(() => {
        fetch(`${mates_backend}/question/fetchUserQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            },
