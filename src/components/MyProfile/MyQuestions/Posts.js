...
export default function Posts({ posts }) {
    ...
    const deleteQue = async (id) => {
        const response = await fetch(`${mates_backend}/question/deleteque/${id}`, {
            method: 'POST',
            headers: {
    ...
    const FindFrequencyOfAns = async () => {
        ...
        const response = await fetch(`${mates_backend}/answer/findNumberOfAns`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const fetchVotes = async () => {
        ...
        const response = await fetch(`${mates_backend}/question/fetchallVotes`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
